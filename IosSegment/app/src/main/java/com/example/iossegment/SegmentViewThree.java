package com.example.iossegment;
...
public class SegmentViewThree extends LinearLayout {
    private TextView textView1;
    private TextView textView2;
    private TextView textView3;
    private onSegmentViewClickListener listener;
    public SegmentViewThree(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SegmentViewThree(Context context) {
        super(context);
        init();
    }
